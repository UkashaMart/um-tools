  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <Script id="google-translate" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit" strategy="afterInteractive" />
        <Script id="google-translate-init" strategy="afterInteractive">{`
          function googleTranslateElementInit() {
            new google.translate.TranslateElement({
              pageLanguage: 'en',
              includedLanguages: 'en,ur,ar,hi,bn,tr,fr,de,es,zh-CN,ru,fa,ms,id',
        ...
        <header style={{ background:"#111827", borderBottom:"1px solid rgba(212,160,23,0.4)", padding:"0 1.25rem", display:"flex", alignItems:"center", gap:"0.75rem", height:"52px", position:"sticky", top:0, zIndex:100 }}>
          ...
          <div style={{ marginLeft:"auto", display:"flex", gap:"1rem", alignItems:"center" }}>
            <div id="google_translate_element" style={{ fontSize:"0.8rem" }}></div>
