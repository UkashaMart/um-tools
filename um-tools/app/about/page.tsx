...
export const metadata: Metadata = {
  ...
  description: "Free online utility tools for users worldwide.",
};
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#111827,#1a2235)", border: "1px solid rgba(212,160,23,0.3)", borderRadius: 14, padding: "2rem", marginBottom: "1.25rem" }}>
        ...
        <p style={{ fontSize: ".9rem", color: "#9A8F78", lineHeight: 1.8 }}>
          The aim of UM Tools is to provide users in Pakistan and around the world with <strong style={{ color: "#F0E6C8" }}>free, fast, and privacy-first</strong> online web utilities. No signups required, zero data collection.
        </p>
      </div>
      ...
      <div className="card">
        {[
          ["ti-bolt", "Fast", "All tools work instantly right in your browser."],
          ["ti-shield", "Private", "Your data never touches our servers. Pure privacy."],
          ["ti-coin", "Free", "Absolutely 100% free with no hidden charges or subscriptions."],
          ["ti-device-mobile", "Mobile Friendly", "Fully optimized to work flawlessly on both mobile and desktop."]
        ].map(([icon, title, desc]) => (
