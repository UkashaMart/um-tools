...
const currencies = [
  { code: "PKR", name: "Pakistani Rupee", symbol: "?", nisab: 87480 },
  { code: "USD", name: "US Dollar", symbol: "$", nisab: 315 },
  { code: "EUR", name: "Euro", symbol: "€", nisab: 290 },
  { code: "GBP", name: "British Pound", symbol: "£", nisab: 250 },
  { code: "SAR", name: "Saudi Riyal", symbol: "?", nisab: 1180 },
  { code: "AED", name: "UAE Dirham", symbol: "?.?", nisab: 1160 },
  { code: "CAD", name: "Canadian Dollar", symbol: "CA$", nisab: 430 },
  { code: "AUD", name: "Australian Dollar", symbol: "A$", nisab: 480 },
  { code: "MYR", name: "Malaysian Ringgit", symbol: "RM", nisab: 1480 },
  { code: "IDR", name: "Indonesian Rupiah", symbol: "Rp", nisab: 5100000 },
  { code: "BDT", name: "Bangladeshi Taka", symbol: "?", nisab: 34500 },
  { code: "INR", name: "Indian Rupee", symbol: "?", nisab: 26000 },
  { code: "TRY", name: "Turkish Lira", symbol: "?", nisab: 10200 },
  { code: "EGP", name: "Egyptian Pound", symbol: "E£", nisab: 15500 },
  { code: "KWD", name: "Kuwaiti Dinar", symbol: "KD", nisab: 97 },
  { code: "QAR", name: "Qatari Riyal", symbol: "QR", nisab: 1148 },
  { code: "OMR", name: "Omani Rial", symbol: "?.?", nisab: 121 },
  { code: "BHD", name: "Bahraini Dinar", symbol: "BD", nisab: 119 },
  { code: "JOD", name: "Jordanian Dinar", symbol: "JD", nisab: 223 },
  { code: "NGN", name: "Nigerian Naira", symbol: "?", nisab: 504000 },
  { code: "ZAR", name: "South African Rand", symbol: "R", nisab: 5900 },
  { code: "CHF", name: "Swiss Franc", symbol: "Fr", nisab: 283 },
  { code: "SGD", name: "Singapore Dollar", symbol: "S$", nisab: 425 },
];
        ...
        {a > 0 && (
          <div>
            <div style={{ display:"flex", flexWrap:"wrap", gap:".6rem", marginBottom:".6rem" }}>
              <div className="stat-box"><div style={{ fontSize:"1.1rem", fontWeight:600, color:"#F5C842" }}>{selected.symbol}{zakat ? zakat.toLocaleString(undefined,{maximumFractionDigits:2}) : "0"}</div><div style={{ fontSize:".65rem", color:"#9A8F78", marginTop:2 }}>Zakat Due</div></div>
              <div className="stat-box"><div style={{ fontSize:"1rem", fontWeight:600, color:zakat?"#4ade80":"#ef4444" }}>{zakat?"Wajib ?":"Wajib Nahi"}</div><div style={{ fontSize:".65rem", color:"#9A8F78", marginTop:2 }}>Status</div></div>
              <div className="stat-box"><div style={{ fontSize:"1rem", fontWeight:600, color:"#F5C842" }}>2.5%</div><div style={{ fontSize:".65rem", color:"#9A8F78", marginTop:2 }}>Rate</div></div>
            </div>
            {zakat ? (
