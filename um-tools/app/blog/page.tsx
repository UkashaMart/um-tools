...
export const metadata: Metadata = {
  ...
  description: "Free guides on Zakat, BMI, Password Security, and more useful tools worldwide.",
};
...
export default function BlogPage() {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: ".78rem", color: "#9A8F78", marginBottom: "1.25rem" }}>Guides, tips, and how-to articles</p>
